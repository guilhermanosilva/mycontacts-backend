...
_Para seguir com a execução é necessário ter o Docker e o gerenciador de pacotes Yarn instalado._
...
1. Instalar todas as dependências da aplicação com o comando:

```bash
yarn install
```

2. Verificar se o seu container docker do banco de dados está em execução (Status UP):
...
4. A api estará em execução quando você ver o seguinte texto no terminal:
